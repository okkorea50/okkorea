        ...
        <div className="w-full min-h-screen bg-[#080812] text-white flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center px-6 pt-[120px] pb-[60px]">
                <div className="max-w-md w-full bg-[#12121A] border border-white/5 rounded-3xl p-10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#FBBF24]/10 rounded-full blur-3xl group-hover:bg-[#FBBF24]/20 transition-all duration-700"></div>

                    <div className="relative z-10 text-center space-y-8">
                        <div>
                            <div className="w-16 h-16 bg-[#FBBF24]/10 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-[#FBBF24]/20">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-white text-[#080812] rounded-xl font-black text-lg flex items-center justify-center gap-3 hover:scale-[1.02] transition-transform shadow-[0_0_30px_rgba(255,255,255,0.1)] active:scale-[0.98]"
                        >
                        ...
                        <div className="pt-4 text-xs font-bold text-white/20 uppercase tracking-[0.2em]">
